import { ProcessedDriver, DriverStanding } from "@/types/driver";
import { ProcessedConstructor, ConstructorStanding } from "@/types/constructor";
import {
  ProcessedRace,
...
export function mapToProcessedDriver(
...
export function mapToProcessedConstructor(
...
export function mapToProcessedRace(race: Race): ProcessedRace {
  ...
  return {
    ...
    time: race.time,
    isPast: raceDate < now,
    isNext: false, // Se asigna más adelante al armar el calendario completo
...
export function mapToProcessedRaceWithResults(
...
export function mapDriverStandings(
