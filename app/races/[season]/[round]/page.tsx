          ...
          <div className="min-w-[520px]">
            ...
            {race.results.map((result) => {
              ...
              return (
                ...
                >
                  <span
                    className={`text-sm font-black tabular-nums ${isTopThree ? "text-[var(--color-f1-red)]" : "text-[var(--color-text-muted)]"}`}
                  >
                    {result.positionText}
                  </span>
                  ...
                  <span
                    className={`text-sm tabular-nums hidden sm:block ${isDNF ? "text-amber-400" : "text-[var(--color-text-secondary)]"}`}
                  >
